  ...
  return (
    <AsiaProgramsContainer>
      <article className="program-wrap">
        <section className="timeline-wrap timeline-0" style={{margin: "20px 20px 50px 20px"}}>
                ...
                <ul className={"cbp_tmtimeline"}>
                  {
                    programs.filter(program => {
                      ...
                      (
                        <ProgramContent key={index} {...program} index={index}/>
                      )
                    ))
                  }
                </ul>
      ...
      <button className="download-btn" onClick={() => {
        window.open('https://d25unujvh7ui3r.cloudfront.net/asia/program/NSSA_program.pdf')
      }}>
        DOWNLOAD
      </button>
    </AsiaProgramsContainer>
