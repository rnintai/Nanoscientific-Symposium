...
export const globalData = new Map<string, Common.globalDataType>([
  ...
  [
    "asia",
    {
      logoURL: `${S3_URL}/asia/menu-bar-logo.svg?v=0.02`,
      speakers: "SPEAKERS",
      programs: "PROGRAM",
  ...
  [
    "kr",
    {
      logoURL: `${S3_URL}/kr/menu-bar-logo.svg?v=0.02`,
      speakers: "초청연사",
      symposium: "심포지엄 안내",
      programs: "프로그램",
      lectureHall: "온라인 강연장",
  ...
  [
    "jp",
    {
      logoURL: `${S3_URL}/jp/menu-bar-logo.svg?v=0.02`,
      speakers: "講演者",
      programs: "プログラム",
      lectureHall: "Web講演会",
      exhibitHall: "展示会",
  ...
  [
    "us",
    {
      logoURL: `${S3_URL}/us/menu-bar-logo.svg?v=0.02`,
      speakers: "SPEAKERS",
      programs: "PROGRAM",
      lectureHall: "LECTURE HALL",
      exhibitHall: "EXHIBIT HALL",
  ...
  [
    "eu",
    {
      logoURL: `${S3_URL}/eu/menu-bar-logo.svg?v=0.02`,
      speakers: "SPEAKERS",
      programs: "PROGRAM",
      lectureHall: "LECTURE HALL",
      exhibitHall: "EXHIBIT HALL",
